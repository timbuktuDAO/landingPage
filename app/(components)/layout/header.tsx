'use client'
import { timbuktuLogo } from "@/app/(util)/common";

export default function Header(){
    return(
        <>
        <header>
    <nav className="bg-dark-800 text-white border-gray-200 px-4 lg:px-6 py-2.5">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <a href="/" className="flex items-center">
                <img src={timbuktuLogo} className="mr-3 h-6 sm:h-9" alt="Timbuktu logo" />
                <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Timbuktu DAO</span>
            </a>
            <div className="flex items-center lg:order-2">
                ...
                onClick={()=>{
                    window.location.replace('https://t.me/+Jb86kyyEjVMyNWY0')
                }}>Join Community</a>
            ...
            <div className="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                    ...
                    <li>
                        <a href="#" className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Our Team</a>
                    </li>
                    <li>
